        ...
        public IEnumerator TimeChange()
        {
            while (true)
            {
                ...
                while (Hour >= 3 && Hour < 5)
                {
                    ...
                    RenderSettings.fogDensity = Mathf.Lerp(0.025f, 0.015f, t);
                    yield return null;
                }
                ...
                while (Hour >= 5 && Hour < 7)
                {
                    ...
                    RenderSettings.fogDensity = Mathf.Lerp(0.015f, 0.02f, t);
                    yield return null;
                }
                ...
                while (Hour >= 15 && Hour < 17)
                {
                    ...
                    RenderSettings.fogDensity = Mathf.Lerp(0.02f, 0.02f, t);
                    yield return null;
                }
                ...
                while (Hour >= 17 && Hour < 21)
                {
                    ...
                    RenderSettings.fogDensity = Mathf.Lerp(0.02f, 0.025f, t);
                    yield return null;
                }
